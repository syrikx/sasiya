package net.sourceforge.sasiya.CameraController;
...
public class CameraController2 extends CameraController {
	...
	private class CameraSettings {
		...
		private boolean setEdgeMode(CaptureRequest.Builder builder) {
			...
			if( has_edge_mode ) {
				...
				// see https://sourceforge.net/p/sasiya/discussion/general/thread/48bd836b/ ,
	...
	public void release() {
		...
		if( thread != null ) {
			...
			// see https://sourceforge.net/p/sasiya/discussion/general/thread/32c2b01b/?limit=25
			thread.quitSafely();
			try {
				thread.join();
				thread = null;
	...
	private void setManualExposureTime(CaptureRequest.Builder stillBuilder, long exposure_time) {
		...
		if( exposure_time_range != null && iso_range != null ) {
			...
			stillBuilder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_OFF);
			{
				...
				// see https://sourceforge.net/p/sasiya/tickets/321/ - some devices may have auto ISO that's
