...
public class CameraController1 extends CameraController {
			...
			if( parameters.get(iso_key) == null ) {
				...
				if( parameters.get(iso_key) == null ) {
					if ( Build.MODEL.contains("Z00") )
						iso_key = "iso"; // Asus Zenfone 2 Z00A and Z008: see https://sourceforge.net/p/sasiya/tickets/183/
					else
	...
	public void cancelAutoFocus() {
		try {
			...
			// had a report of crash on some devices, see comment at https://sourceforge.net/p/sasiya/tickets/4/ made on 20140520
			if(MyDebug.LOG)
