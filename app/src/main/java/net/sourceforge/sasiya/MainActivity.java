...
import net.sourceforge.sasiya.CameraController.CameraControllerManager2;
import net.sourceforge.sasiya.Preview.Preview;
import net.sourceforge.sasiya.Preview.VideoProfile;
import net.sourceforge.sasiya.UI.FolderChooserDialog;
import net.sourceforge.sasiya.UI.MainUI;
import net.sourceforge.sasiya.UI.ManualSeekbars;
...
public class MainActivity extends Activity {
	...
	static private final String ACTION_SHORTCUT_CAMERA = "net.sourceforge.sasiya.SHORTCUT_CAMERA";
	static private final String ACTION_SHORTCUT_SELFIE = "net.sourceforge.sasiya.SHORTCUT_SELFIE";
	static private final String ACTION_SHORTCUT_VIDEO = "net.sourceforge.sasiya.SHORTCUT_VIDEO";
	static private final String ACTION_SHORTCUT_GALLERY = "net.sourceforge.sasiya.SHORTCUT_GALLERY";
	static private final String ACTION_SHORTCUT_SETTINGS = "net.sourceforge.sasiya.SHORTCUT_SETTINGS";
	...
	public boolean is_test; // whether called from SaSiYa.test testing
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// also added the check for having 128MB standard heap, to support modded LG G2, which has 128MB standard, 256MB large - see https://sourceforge.net/p/sasiya/tickets/9/
...

		{
			...
			if( version_code != -1 ) {
				...
				if( whats_new_enabled ) {
					...
					boolean allow_show_whats_new = sharedPreferences.getBoolean(PreferenceKeys.ShowWhatsNewPreferenceKey, false);
					if(MyDebug.LOG)
	...
	void launchOnlineHelp(String append) {
		...
		Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://sasiya.sourceforge.io/"+ append));
		startActivity(browserIntent);
	}
    ...
    public void updateGalleryIcon() {
		...
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
		String ghost_image_pref = sharedPreferences.getString(PreferenceKeys.GhostImagePreferenceKey, "preference_ghost_image_face_guide");
            ...
            if( resultCode == RESULT_OK && resultData != null ) {
				...
				try {
					...
					if( uri.length() == 0 ) {
						...
						SharedPreferences.Editor editor = sharedPreferences.edit();
						editor.putString(PreferenceKeys.GhostImagePreferenceKey, "preference_ghost_image_face_guide");
						editor.apply();
					}
				}
			}
