package net.sourceforge.sasiya.Preview;
...
import net.sourceforge.sasiya.TakePhoto;
import net.sourceforge.sasiya.ToastBoxer;
import net.sourceforge.sasiya.CameraController.CameraController;
import net.sourceforge.sasiya.CameraController.CameraController1;
import net.sourceforge.sasiya.CameraController.CameraController2;
import net.sourceforge.sasiya.CameraController.CameraControllerException;
import net.sourceforge.sasiya.CameraController.CameraControllerManager;
import net.sourceforge.sasiya.CameraController.CameraControllerManager1;
import net.sourceforge.sasiya.CameraController.CameraControllerManager2;
import net.sourceforge.sasiya.Preview.ApplicationInterface.NoFreeStorageException;
import net.sourceforge.sasiya.Preview.CameraSurface.CameraSurface;
import net.sourceforge.sasiya.Preview.CameraSurface.MySurfaceView;
import net.sourceforge.sasiya.Preview.CameraSurface.MyTextureView;
...
public class Preview implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
	...
	private boolean is_test; // whether called from SaSiYa.test testing
	 ...
	 */
	public void retrySaSiYa() {
		if(MyDebug.LOG)
			Log.d(TAG, "retrySaSiYa()");
        if( camera_controller == null ) {
    		if(MyDebug.LOG)
	 ...
	 */
	private void takePhotoWhenFocused() { 		// should be called when auto-focused
		if(MyDebug.LOG)
